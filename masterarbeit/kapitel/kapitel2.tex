...
\glqq{}White-Box\grqq{}-Ansätzen. Letzteres wird im
...
kann nur mittels Ein- und Ausgaben mit der Umwelt bzw. der
...
Programmschnittstelle zwingend erforderlich.
...
einen bestimmten Kontrollfluss zur Folge hat, und einen Testfall
...
bestimmten Format. Im Fall der Black-Box existiert diese Information
...
Auch der Zustand einer solchen Black-Box kann nur über seine Ausgaben
implizit überwacht werden. Ansätze wie der von Angluin\cite{angluin}
haben zum Ziel, die wiederholbaren Zustände innerhalb einer Black-Box
durch Kontrolle der Eingaben und Ausgaben abzubilden. Wenn auf eine
identische Eingabe eine abweichende Antwort erfolgt, muss die Black-Box
...
Es gibt also vorgegebene Eingaben und erwartete Antworten.
...
mit einer ganzen Eingabefamilie und White-Box, um die Korrektheit
einer Implementation sicherzustellen. Im Fall, wo kein Quellcode
vorliegt, muss grundsätzlich ein Black-Box-Test eingesetzt werden.
