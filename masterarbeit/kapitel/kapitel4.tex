...
Das zu testende Programm muss folglich als ``Black Box'' verstanden werden.
...
``SearchDialog''. Sie dient der Auswahl einer Datei oder eines Ordners
...
Worin unterscheiden sich nun verschiedene Instanzen von ``SearchDialog''?
...
Üblicherweise ist dies der ``simple Classname'', der einfache Klassenname,
...
ohne jegliche Beschriftung ziehen wir den ``Tooltip'' heran,
